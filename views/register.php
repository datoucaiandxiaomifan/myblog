...
<link rel="stylesheet" href="<?php echo site_url('assets/front/css/register.css');?>">
<!--[if lt IE 9]>
...
<body>
  ...
  <div class="inner">
      <div class="login layout">
          <div class="l">
              <h2>新用户注册</h2>
              <form name="aspnetForm" method="post" action="<?php echo site_url('control/do_register');?>" id="aspnetForm" class="form">
                  ...
                  <p><label>确认密码：</label><input name="spwd" type="password" id="pwd1" class="text" placeholder="Rpassword" ><br></p>
                  <p><label></label><input type="button" name="Button" value="" id="Button1" class="lregist"></p>
              </form>
          </div>
          <div class="r">
              <div class="rcon">
                    已经是本网用户？<br><br>
                  <a class="fastregist" href="<?php echo site_url('control/login'); ?>"></a>
                  <br>
                  <br>
              </div>
          </div>
  ...
  <script src="<?php echo site_url('assets/front/js/form.js');?>"></script>
<div id="copright">Design by <a href="<?php echo site_url('control/index'); ?>" target="_blank">DanceSmile</a></div>
